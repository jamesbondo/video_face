...
if __name__=='__main__':
    '''
        resize image
    '''
    url = '/home/aurora/hdd/video/train_images/have_people/'
    files = [os.path.join(url, f) for f in os.listdir(url)]
    # save_url = '/home/aurora/hdd/video/20150918_npy_128/'
    save_url = '/home/aurora/hdd/video/train_images/people128/'
    ...
    url2 = '/home/aurora/hdd/video/train_images/no_people/'
    files2 = [os.path.join(url2, f) for f in os.listdir(url2)]
    # save_url = '/home/aurora/hdd/video/20150918_npy_128/'
    save_url2 = '/home/aurora/hdd/video/train_images/nopeople128/'
